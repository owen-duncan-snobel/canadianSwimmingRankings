...
import * as swimmingFiles from './components/swimmerData/2007-2008/Short_Course/2020-01-31/Female_0_Events/.json';
...
require('./components/swimmerData/2007-2008/Short_Course/2020-01-31/Female_0_Events/' + name + '.json');

function App() {
  const swimFiles = Object.values(swimmingFiles);
  console.log(swimFiles)
